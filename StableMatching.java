...
public class StableMatching {
    ...
    public static void main(String... theArgs) {
        StableMatching matches = new StableMatching();
        Set<Person> result = matches.propose(matches.womenSet);
    ...
    private Map<String, List<String>> setPreferenceMap() {
        ...
        //        for (String name: menSet) {
//            map.put(name, new ArrayList<>());
//
//            String nameList = name.toUpperCase() + "_LIST";
////            System.out.println(nameList);
////            String[] nameList =
//
//            try {
//                Field field = this.getClass().getDeclaredField(nameList);
//                field.setAccessible(true);
//
//                for (String target: field.get()) {
//                    map.get(name).add(target);
//                }
